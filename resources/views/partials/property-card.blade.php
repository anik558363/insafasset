          ...
          <div class="p-3 d-flex flex-column" style="flex:1;">
              ...
              <div class="d-flex flex-wrap gap-2 mb-2">
                  ...
                  @if ($property->bedrooms)
                      <span class="prop-meta"><i class="bi bi-door-closed"></i>{{ $property->bedrooms }} {{ __('messages.common.bed') }}</span>
                  @endif
                  @if ($property->bathrooms)
                      <span class="prop-meta"><i class="bi bi-droplet"></i>{{ $property->bathrooms }} {{ __('messages.common.bath') }}</span>
                  @endif
              </div>
